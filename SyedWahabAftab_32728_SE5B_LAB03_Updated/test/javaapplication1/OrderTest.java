...
public class OrderTest {
    ...
    public void testSet_priority() {
        ...
        Order instance = new Order("wahaba","lunch",1,4,"E",PQ,TC,5,8);
    ...
    public void test_waiting_time() {
        ...
        Priority_Queue PQ= new Priority_Queue();
        Table_Creator TC= new Table_Creator();
        Order instance = new Order("saad","lunch",1,4,"E",PQ,TC,2,8);
    ...
    public void test_allocated() {
        ...
        Priority_Queue PQ= new Priority_Queue();
        Table_Creator TC= new Table_Creator();
        Order instance = new Order("wahab","lunch",1,4,"E",PQ,TC,9,7);
